...
//
//            Text btn = new Text();
//            btn.setText(workshops.get(i).getName()+" ("+workshops.get(i).getMake()+") ("+workshops.get(i).getModel()+") ("+workshops.get(i).getPlateNumber()+")");
//            vehicleGrid.add(btn, 0, i); // Text is added to next row every time.
//
//        }
...
//		table.refresh();
		...
		tableRatings.setCellValueFactory(cellData->	new SimpleStringProperty(Double.toString(cellData.getValue().getRatings())));
		table.setItems(workshops);
		WorkshopServices.clear();
//		for (final Node node : searchGrid.getChildren()) {
////	        
////	            searchGrid.getChildren().clear();
//		searchGrid.getChildren().removeAll(node);
////	        
//	    }
//		searchGrid.remo
//		while(searchGrid.getRowConstraints().size() > 0){
//			searchGrid.getRowConstraints().remove(0);
//		}
//
//		while(searchGrid.getColumnConstraints().size() > 0){
//			searchGrid.getColumnConstraints().remove(0);
//		}
